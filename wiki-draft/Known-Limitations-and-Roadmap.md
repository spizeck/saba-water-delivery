...
| Audit atomicity        | Resolved: required audit events now commit in the same Firestore transaction as their change. The one residual boundary is the external Firebase Authentication deletion in an account merge, recorded best-effort on the merge audit record. | [#49](https://github.com/spizeck/saba-water-delivery/issues/49) |
